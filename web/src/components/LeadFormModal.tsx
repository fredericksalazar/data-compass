...
export default function LeadFormModal({ apiUrl, answers, onSuccess }: LeadFormModalProps) {
  ...
  return (
    <div className="px-6 py-8 overflow-y-auto max-h-[90vh]">
      ...
      <h3 className="text-xl font-bold text-white text-center mb-1">¡Tu informe está listo!</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-3 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
          />
        </div>
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1">
              Cargo <span className="text-slate-600 font-normal">(opcional)</span>
            </label>
            <input
              type="text"
        ...
        <div>
          <label className="block text-xs font-medium text-slate-400 mb-1">
            Correo <span className="text-slate-600 font-normal">(opcional)</span>
          </label>
          <input
            type="email"
      ...
      <div className="rounded-xl border border-slate-700/50 bg-slate-800/40 p-4">
        <p className="text-xs font-semibold uppercase tracking-widest text-slate-500 mb-1.5">Apoya DataCompass</p>
        ...
        <p className="mt-2 text-xs text-slate-600">Sugerido: $10 USD · 100% voluntario</p>
      </div>
