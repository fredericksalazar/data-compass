  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <span style={{ fontSize: 11, color: '#94a3b8' }}>DataCompass · Diagnóstico CMMI Freemium</span>
        <span style={{ fontSize: 11, color: '#94a3b8' }}>data-compass-app.web.app</span>
      </div>
    </div>
  );
}
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#64748b', marginBottom: 16 }}>
      {children}
    </p>
  );
}
    ...
    <Page id="pdf-page-1">
      <div style={{ padding: '48px 56px 40px', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 80 }}>
          ...
          <span style={{ color: '#0f172a', fontSize: 20, fontWeight: 700, letterSpacing: -0.5 }}>
            Data<span style={{ color: '#2563eb' }}>Compass</span>
          </span>
          <span style={{ marginLeft: 8, fontSize: 11, color: '#94a3b8', border: '1px solid #e2e8f0', borderRadius: 20, padding: '2px 10px' }}>
            Freemium
          </span>
        </div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <p style={{ fontSize: 13, color: '#94a3b8', marginBottom: 16, fontWeight: 500, letterSpacing: 1 }}>
            REPORTE DE MADUREZ EN GOBERNANZA DE DATOS
          </p>
          <h1 style={{ fontSize: 42, fontWeight: 800, color: '#0f172a', lineHeight: 1.15, marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 56 }}>
            <p style={{ fontSize: 14, color: '#475569' }}>
              <span style={{ color: '#94a3b8' }}>Preparado para: </span>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: 32, fontWeight: 800, color: '#0f172a', lineHeight: 1 }}>
                ...
                <span style={{ fontSize: 16, color: '#94a3b8', fontWeight: 400 }}> / 5.0</span>
              </p>
            </div>
            <div style={{ width: 1, height: 48, background: `${levelColor}30` }} />
            <div>
              <p style={{ fontSize: 12, color: '#94a3b8', marginBottom: 2 }}>Nivel {levelNumber}</p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: '#64748b', lineHeight: 1.6 }}>
            <span style={{ color: '#475569', fontWeight: 600 }}>Informe Freemium completo · </span>
      ...
      <div style={{ padding: '40px 52px 56px', boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, flexShrink: 0 }}>
            <div style={{ position: 'relative', width: 160, height: 160 }}>
              <svg width="160" height="160" viewBox="0 0 120 120" style={{ transform: 'rotate(-90deg)' }}>
                <circle cx="60" cy="60" r="54" fill="none" stroke="rgba(15,23,42,0.08)" strokeWidth="10" />
                <circle
                  cx="60" cy="60" r="54"
                  fill="none"
                  stroke={levelColor}
              ...
              <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontSize: 32, fontWeight: 800, color: '#0f172a', lineHeight: 1 }}>{result.overall_score.toFixed(1)}</span>
                <span style={{ fontSize: 12, color: '#94a3b8' }}>de 5.0</span>
              </div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <p style={{ fontSize: 11, color: '#94a3b8', fontWeight: 600, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 4 }}>Nivel {levelNumber}</p>
        ...
        <div style={{
          ...
          {radarImageUrl
            ...
            : <p style={{ color: '#94a3b8', fontSize: 13 }}>Gráfico no disponible</p>
          }
        </div>
    ...
    <Page id="pdf-page-3">
      <div style={{ padding: '40px 52px 56px', boxSizing: 'border-box' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, color: '#0f172a', lineHeight: 1.6, marginBottom: 8 }}>{ctx.context}</p>
          <p style={{ fontSize: 13, color: '#475569', lineHeight: 1.6, borderTop: '1px solid #e2e8f0', paddingTop: 10 }}>{ctx.implication}</p>
        </div>

        {/* Domain insights */}
        <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#64748b', marginBottom: 14 }}>Análisis por dominio</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
          <div style={{ borderRadius: 10, border: '1px solid rgba(34,197,94,0.25)', background: 'rgba(34,197,94,0.06)', padding: '14px 18px' }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', marginBottom: 3 }}>{best.domain_name}</p>
            <p style={{ fontSize: 13, fontWeight: 700, color: '#22c55e' }}>{best.score.toFixed(1)} / 5.0</p>
          </div>
          <div style={{ borderRadius: 10, border: '1px solid rgba(239,68,68,0.25)', background: 'rgba(239,68,68,0.06)', padding: '14px 18px' }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', marginBottom: 3 }}>{worst.domain_name}</p>
            <p style={{ fontSize: 13, fontWeight: 700, color: '#ef4444' }}>{worst.score.toFixed(1)} / 5.0</p>
          </div>
        </div>

        {/* Strategic recommendation */}
        <div style={{ borderRadius: 10, border: '1px solid rgba(37,99,235,0.2)', background: 'rgba(37,99,235,0.05)', padding: '14px 18px' }}>
          <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1.5, color: '#2563eb', textTransform: 'uppercase', marginBottom: 8 }}>Recomendación estratégica</p>
    ...
    <Page id="pdf-page-4">
      <div style={{ padding: '40px 52px 56px', boxSizing: 'border-box' }}>
        ...
        <p style={{ fontSize: 13, color: '#475569', lineHeight: 1.7, marginBottom: 32 }}>
          El modelo CMMI (Capability Maturity Model Integration) define cinco niveles de madurez para evaluar la capacidad de una organización en la gestión y gobernanza de sus datos. Tu organización se encuentra actualmente en el <span style={{ color: '#0f172a', fontWeight: 600 }}>Nivel {currentLevel}</span>.
        </p>
          ...
          {CMMI_LEVELS.map(l => {
            ...
            return (
              <div
                ...
                style={{
                  borderRadius: 10,
                  border: isCurrentLevel ? `2px solid ${color}60` : '1px solid #e2e8f0',
                  background: isCurrentLevel ? `${color}08` : '#f8fafc',
                  padding: '16px 20px',
                  display: 'flex',
                  gap: 20,
              ...
              >
                <div style={{
                  ...
                  height: 40,
                  borderRadius: 10,
                  background: isCurrentLevel ? `${color}15` : '#f1f5f9',
                  border: `1px solid ${isCurrentLevel ? `${color}40` : '#e2e8f0'}`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  flexShrink: 0,
                }}>
                  <span style={{ fontSize: 16, fontWeight: 800, color: isCurrentLevel ? color : '#94a3b8' }}>{l.n}</span>
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 5 }}>
                    <p style={{ fontSize: 14, fontWeight: 700, color: isCurrentLevel ? '#0f172a' : '#64748b' }}>{l.name}</p>
                    <span style={{ fontSize: 11, color: '#94a3b8' }}>({l.range})</span>
                    {isCurrentLevel && (
                      <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, color, background: `${color}15`, border: `1px solid ${color}40`, borderRadius: 20, padding: '2px 8px', textTransform: 'uppercase' }}>
                        Tu nivel actual
                      </span>
                    )}
                  </div>
        ...
        <div style={{ marginTop: 36, borderTop: '1px solid #e2e8f0', paddingTop: 24 }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#64748b', marginBottom: 12 }}>Glosario</p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px 24px' }}>
            {[
              ...
              <div key={term}>
                <span style={{ fontSize: 11, fontWeight: 600, color: '#475569' }}>{term}: </span>
    ...
    <Page id="pdf-page-5">
      <div style={{ padding: '40px 52px 56px', boxSizing: 'border-box' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#94a3b8', marginBottom: 12 }}>
            Apoya DataCompass
          </p>
          <p style={{ fontSize: 20, fontWeight: 700, color: '#0f172a', marginBottom: 10 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 16, flexWrap: 'wrap' }}>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p style={{ fontSize: 10, color: 'rgba(255,255,255,0.8)' }}>{CONTACT.PAYPAL_EMAIL} · mín. $10 USD</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#64748b', marginBottom: 12 }}>
          ...
          <p style={{ fontSize: 11, color: '#94a3b8', lineHeight: 1.8, marginTop: 10 }}>
        ...
        <div style={{ marginTop: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <p style={{ fontSize: 11, color: '#94a3b8' }}>ID: {result.assessment_id}</p>
          <p style={{ fontSize: 11, color: '#94a3b8' }}>Generado el {formatDate(new Date())} · DataCompass Freemium</p>
        </div>
      </div>
    </Page>
  );
